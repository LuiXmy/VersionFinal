...
//		System.out.println("\tFUNCION "+t.image);
        ...
        private static void usarASIGINT(String s, int e){
            System.out.println("\u005ct"+s+"="+e);
            Tercetos ter = new Tercetos();
            tupla_Tercetos tupla = new tupla_Tercetos(tablaactiva,ter.asignacion_valor(s,e));
        lista.add(tupla);
        }
        ...
        private static void copiarVectorEnOtro(Symbol tmp, Symbol tmp2)
        {
                ...
                //Final
                Tercetos ter = new Tercetos();
                tupla_Tercetos tupla = new tupla_Tercetos(tablaactiva,ter.asignacion(tmp.key,tmp2.key));
                lista.add(tupla);
        }
        ...
        private static void asignacionVector(String id, String exp, String exp1)
        {
                ...
                //Final
                Tercetos ter = new Tercetos();
                tupla_Tercetos tupla = new tupla_Tercetos(tablaactiva,ter.meteEnArray(id,exp1,exp));
                lista.add(tupla);
                //usarLabel(etiq);
        }
        ...
        if (args.length == 1)
              ...
              {
                System.out.println("Error Sintactico \u00f3 Sem\u00e1ntico, ga\u00f1an.");
                System.out.println(e.getMessage());
                return;
              }
            }
...
//			}
      ...
      case VAR:
        ...
        case ASIGNACION:
          ...
          expr = Expresion(t.image);
                ...
                {
                        System.out.println("lo que contiene"+expr._str);
      ...
      case IDENTIFICADOR:
        ...
        expr = Expresion(t.image);
                                ...
                                //Si los tipos son distintos hay que ponerle el valor del de la derecha
  ...
  static final public Expresion VectorExpression() throws ParseException {
    ...
    while (true) {
      ...
      jj_consume_token(CORCHETEIZQ);
                ...
                if(expr2!=null)
                {
                        System.out.println("\u005ctse comprueba indice en final\u005cn"+tmp+" = "+expr._str+ "[ "+expr2._str+" ]");
                        simbolo=new Symbol(tmp, t.beginLine, ENTERO);
                        tablaactiva.insertarTS(tmp,simbolo);
                        Expresion resultado = new Expresion(tmp, ENTERO);
                        Symbol simbolo2=tablaactiva.obtenerSimbolo(expr._str);
                        tmp2 = nuevaTmp();
                        Symbol simbolo3 = new Symbol(tmp2, t.beginLine, ENTERO);
                        usarASIGINT(tmp2,simbolo2.numeroelementos-1);
                        tablaactiva.insertarTS(tmp2,simbolo3);
                        //Final
                        // Comprueba indice del vector
                        String etiqueta1=nuevaEtq();// etqFalso
                        ...
                        lista.add(tupla);
                        ter = new Tercetos();
                        tupla = new tupla_Tercetos(tablaactiva,ter.halt());
                        lista.add(tupla);
                        usarLabel(etiqueta1);
                        ter = new Tercetos();
                        tupla = new tupla_Tercetos(tablaactiva,ter.sacaDeArray(expr._str,tmp,expr2._str));
                        lista.add(tupla);
                        Expresion expr4=new Expresion(tmp,ENTERO);
                        {if (true) return expr4;}
                }
                if(t!=null)
                {
                        Expresion expr4=new Expresion(expr._str,VECTOR);
                        {if (true) return expr4;}
                }
    }
                {if (true) return expr;}
  ...
  static final public Vector ArgumentList(Token nombre) throws ParseException {
    ...
    case PARENDRCHA:
      expr1 = Expresion("");
                ...
                {
                        {if (true) throw new Error("Error en la linea ("+nombre.beginLine+"): El(Los) parametro(s) tiene(n) que ser declarado(s) antes de usarlo(s)");}
                }
      label_9:
      while (true) {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    ...
    default:
      ...
      ;
                ...
                {
                        {if (true) throw new Error("Error en la linea ("+nombre.beginLine+"): El(Los) parametro(s) de la llamada no coincide(n) con el(los) de la declaraci\u00f3n");}
 ...
 Expresion st = null;
    ...
    case STRING_LITERAL:
      t = jj_consume_token(STRING_LITERAL);
                ...
                String tmp = nuevaTmp();
                Symbol simbolo = new Symbol(tmp, t.beginLine, CADENA);
                usarAsigCadena(tmp, cadena);
                tablaactiva.insertarTS(tmp, simbolo);
                st = new Expresion(tmp, t.kind);
                st.t = t;
      break;
    default:
      jj_la1[24] = jj_gen;
